...
import {BlockBase, BlockRef, ForkException} from '../../../common'
import {wait} from '../../../util/async'
import {LineSplitter} from '../../../util/line-splitter'
import {ensureError, last} from '../../../util/misc'
...
function isValid<V extends Validator<any>>(validator: V, value: unknown): value is GetSrcType<V> {
